...
| 구분           | 실행 전         | 실행 후         | 변화량                |
| ------------ | ------------ | ------------ | ------------------ |
| RX (수신 바이트)  | 약 **388 KB** | 약 **169 MB** | **+169 MB** 이상 증가  |
| TX (송신 바이트)  | 약 **66 KB**  | 약 **5.3 MB** | **+5.2 MB** 이상 증가  |
| RX (수신 패킷 수) | 495 패킷       | 125,917 패킷   | **+125,422 패킷** 증가 |
| TX (송신 패킷 수) | 438 패킷       | 83,741 패킷    | **+83,303 패킷** 증가  |
